...
folder: hydra/developer_resources/workflow_and_mediated_deposit.md
...
Here is a console walk through of what you need to do. You could do this in a rake task (like the `rake hyrax:workflow:load` mentioned above) or ... [TODO: What's our recommended way to set this up?]
